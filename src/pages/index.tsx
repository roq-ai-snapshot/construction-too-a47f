  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental, your central supplier for all your needs. Rent from our multiple outlets, empowering individual customers with construction tools at their fingertips."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental, your central supplier for all your needs. Rent from our multiple outlets, empowering individual customers with construction tools at their fingertips.`}
            </Text>
            <Box
